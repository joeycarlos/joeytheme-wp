...
<body <?php body_class(); ?>>
	...
	<div class="container">
		...
		<div class="site-banner">
			<a href="//localhost/wordpress/about" class="picture-about-link"><img class="header-picture" src="/wordpress/wp-content/themes/joeytheme/images/profile_picture.png"></a>
